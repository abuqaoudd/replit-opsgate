...
PACKAGE = {'name': 'replit-opsgate-engine-foundation',
 ...
 'private': True,
 'type': 'module',
 'scripts': {'build': 'python3 tools/opsgate.py build-distributions',
             'validate': 'python3 tools/opsgate.py validate-engine',
             ...
             'audit:engine': 'python3 tools/opsgate.py audit-engine dist/replit-install',
             ...
             'install:replit': 'python3 tools/opsgate.py build-replit-install',
             'release-notes': 'python3 tools/opsgate.py release-notes',
