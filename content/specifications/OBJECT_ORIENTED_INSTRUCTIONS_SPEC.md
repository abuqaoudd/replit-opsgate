...
Python contracts remain the machine-readable source of truth for routing, gates, protected paths, and schemas. Markdown instruction objects explain how agents apply those contracts. If an object conflicts with a Python contract or `replit.md`, fix the source and validation before release.
