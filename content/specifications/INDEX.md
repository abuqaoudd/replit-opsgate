...
|---|---|
| `ENGINE_FOUNDATION_SPEC.md` | Python contract, tool, source-model, state, and report contracts |
...
| `VALIDATION_DISTRIBUTION_SPEC.md` | Behavioral forward-test coverage for routing, phasing, and HITL |
...
- `DIST-*`: behavioral forward-test validation
...
4. validate references, frontmatter, fixtures, and reports;
5. forward-test realistic routing and failure cases.
