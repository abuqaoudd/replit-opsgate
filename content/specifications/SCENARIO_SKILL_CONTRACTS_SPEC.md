...
Required inputs: explicit instruction-change request, exact paths, desired behavior, and version target.
...
5. validate frontmatter, references, and mode-to-skill mapping;
6. forward-test routing, phases, and HITL.
