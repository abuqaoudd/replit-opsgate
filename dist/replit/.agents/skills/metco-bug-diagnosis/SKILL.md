---
name: metco-bug-diagnosis
description: Diagnose a METCO frontend, backend, data, permission, or integration defect from symptoms, logs, reproduction steps, or failing tests. Use for evidence-first root-cause analysis without writes, or for a tightly bounded fix when the user explicitly requests implementation after diagnosis.
---
...
1. Read `../../../replit.md`, `../../../ai/{metco,testing}.md`, and only affected domain files.
