...
ENGINE_MANIFEST = {'name': 'opsgate',
 ...
 'commands': {'validate': 'python3 tools/opsgate.py validate-engine',
              ...
              'init_run': 'python3 tools/opsgate.py init-run <request.json> [--tenant <id>]',
              'record_decision': 'python3 tools/opsgate.py record-decision <HITL-ID> <answer and exact scope> [--tenant <id>]',
