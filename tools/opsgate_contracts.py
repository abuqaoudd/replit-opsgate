...
ENGINE_MANIFEST = {'name': 'replit-opsgate',
 ...
 'commands': {'validate': 'python3 tools/opsgate_tools.py validate-engine',
              'test_all': 'python3 tools/opsgate_tools.py test-all',
              'build': 'python3 tools/opsgate_tools.py build-distributions',
              'route': 'python3 tools/opsgate_tools.py route-request <request.json>',
              'compile': 'python3 tools/opsgate_tools.py compile-prompt <request.json>',
              'init_state': 'python3 tools/opsgate_tools.py init-state <request.json>',
              'parse_report': 'python3 tools/opsgate_tools.py parse-report <report.md>',
              'diff_upgrade': 'python3 tools/opsgate_tools.py diff-upgrade <old-engine-root> [new-engine-root]',
              'intake': 'python3 tools/opsgate_tools.py intake-request "<plain language request>"',
              'next_phase': 'python3 tools/opsgate_tools.py next-phase-prompt <run-state.json> <parsed-report.json>',
              'replit_install': 'python3 tools/opsgate_tools.py build-replit-install',
              'release_notes': 'python3 tools/opsgate_tools.py release-notes <old-engine-root>',
              'preflight': 'python3 tools/opsgate_tools.py preflight <request.json>',
              'check_paths': 'python3 tools/opsgate_tools.py check-paths <request.json>',
              'check_capabilities': 'python3 tools/opsgate_tools.py check-capabilities <request.json>',
              'lint_prompt': 'python3 tools/opsgate_tools.py lint-prompt <prompt.md>',
              'lint_report': 'python3 tools/opsgate_tools.py lint-report <report.md>',
              'audit_engine': 'python3 tools/opsgate_tools.py audit-engine [project-root]',
              'init_run': 'python3 tools/opsgate_tools.py init-run <request.json>',
              'record_decision': 'python3 tools/opsgate_tools.py record-decision <HITL-ID> <answer and exact scope>',
              'show_profile': 'python3 tools/opsgate_tools.py show-profile [request.json]',
              'validate_json': 'python3 tools/opsgate_tools.py validate-json <schema-contract> <data-file>',
