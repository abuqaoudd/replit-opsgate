"""Lightweight lexical analysis for METCO's routing and intake matching.
...
callers can treat a genuine tie as the ambiguity it is (METCO's own HITL case 2 - "two materially
