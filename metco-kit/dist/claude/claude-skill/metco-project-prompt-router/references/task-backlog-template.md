...
6. For complex implementation work, create a phase plan and use `METCO_REPLIT_PHASED_IMPLEMENTATION_TEMPLATE.md`; do not emit one oversized Replit prompt.
